...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto flex flex-col items-center gap-4 text-center md:text-left z-10">
          ...
          <p className="text-xl md:text-2xl font-bold">
            USA Hashrate : <span className="text-[#00b67a]">1,73 PH/s</span>
          </p>
          <Link
            href="/pool"
      ...
      <section className="py-10 bg-gray-100 border-b border-b-black">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-black">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 text-left! text-sm leading-snug">
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          <Link href="/collections/lucky-miners" className="text-3xl md:text-4xl font-bold text-black! review">Bitcoin Merch Exclusive Lottery Miners</Link>
          ...
          <Link href="/collections/lucky-miners" className="underline! review text-black! font-semibold uppercase text-xs">
            Load more
          </Link>
        </div>
      </section>
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          <Link href="/collections/lucky-miners" className="text-3xl md:text-4xl font-bold text-black! review">Bitaxe Miners</Link>
          ...
          <Link href="/collections/bitaxe-miners" className="underline! review text-black! font-semibold uppercase text-xs">
            Load more
          </Link>
        </div>
      </section>
