...
export default async function ProductDetailPage({
  ...
  const secondaryImages = await getProductImages(product ?product?.id:0)
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-center w-full">
          ...
          <div className="w-full lg:w-[50%] bg-white flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3">
              <span className="text-2xl font-bold text-black">${Number(product.price.toFixed(2))-0.01}</span>
              <span className="text-2xl line-through font-bold text-black">${product.price.toFixed(2)}</span>
            </div>
