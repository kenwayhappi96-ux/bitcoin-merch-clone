...
export default function ReviewsPage() {
  return (
    <main className="min-h-screen bg-white py-12">
      ...
      <div className="w-full flex justify-center items-center">
        <Link href='/' className="relative text-black! text-center">
          ...
          <div className='flex gap-2 items-center'>
            <span className="text-[13px] [line-height: 16px] block">
              Rated 4.4/5 based on <span className='underline'>937 views</span>
            </span>
            <span className="block w-16.5">
      ...
      <section className="py-8 px-4 w-full flex">
        <div className="max-w-7xl mx-auto">
          <div className="h-full max-w-full min-h-[150px] min-w-[300px] justify-center will-change-transform relative mx-auto my-0 flex-row items-center flex">
            ...
            <div className='wrapper-right w-full flex flex-col gap-2 px-10 py-0 overflow-hidden'>
              <p className="text-left! text-xs text-gray-500 mt-6 font-medium">
                Showing our 4 & 5 star reviews
              </p>
              <div
                className="relative gap-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 h-full w-full overflow-hidden whitespace-nowrap will-change-transform [transition-timing-function: ease;]"
              >
                {reviews.map((review, idx) => (
                  <div
                    key={idx}
                    className="relative p-3 bg-gray-100 max-w-76.75 inline-block h-auto whitespace-normal [vertical-align: top;]"
                  >
                    {/* Stars + Verified */}
                    <div className="flex items-center gap-4">
                      ...
                      <Link href={'/'} className='review'>
                        ...
                        {/* Reply */}
                        <div className='flex gap-2 justify-between items-center bg-white border-l-2 border-l-green-700 p-2 my-3'>
                          <div className='flex gap-2'>
                            <Reply className='fill-green-700 h-4 w-4'/>
                            <span className='text-xs text-gray-700'>Reply from Bitcoin Merch</span>
                          </div>
                          <span className='text-xs text-gray-700'>{review.date}</span>
                        </div>

                        <button className='flex justify-center items-center cursor-pointer w-full text-sm'>
